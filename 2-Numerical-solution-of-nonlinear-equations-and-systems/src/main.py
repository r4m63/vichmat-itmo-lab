...
from src.settings.congif import LOG_DECIMALS
from src.settings.constants import *
from src.settings.equations import EQUATIONS
from src.settings.systems import SYSTEMS
from src.util.drawers import draw_equation, draw_system
